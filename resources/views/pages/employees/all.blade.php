                                ...
                                <td>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="shadow dropdown-menu dropdown-menu-left animated--fade-in"
                                            ...
                                            <a class="dropdown-item edit-product"
                                                href="{{ route('employees.view',$employe->id) }}" class="btn btn-warning" title="">
                                            ...
                                            <a class="dropdown-item change-status" href="javascript:void(0)" class="btn btn-danger"
                                                title="" onclick="decline('{{ route('employees.status.change',$employe->id) }}')"><i
                                                    class="fas fa-times-circle"></i>&nbsp;Deactivate</a>
                                            @else
                                            <a class="dropdown-item change-status" href="javascript:void(0)" class="btn btn-danger"
                                                title="" onclick="approve('{{ route('employees.status.change',$employe->id) }}')"><i
